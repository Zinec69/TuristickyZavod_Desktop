...
public sealed class Database : DbContext
{
    ...
    public async void LoadTables()
    {
        if (!tablesLoaded)
        {
            ...
            await CheckpointRunnerInfo.LoadAsync();
            await Runner.LoadAsync();
            await Partner.LoadAsync();
            await AgeCategory.LoadAsync();
            await Checkpoint.LoadAsync();
            await Referee.LoadAsync();
            await Team.LoadAsync();
            await CheckpointAgeCategoryParticipation.LoadAsync();
            await Log.LoadAsync();
    ...
    {
        //var str = @$"Data Source={Directory.GetCurrentDirectory()}\tz.db";
        var str = @"Data Source=C:\Users\Zinec\Desktop\Škola\BP\Desktop\tz.db"; // TODO
        optionsBuilder
            .UseSqlite(str)
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgeCategory>().HasData(
            ...
            new AgeCategory() { ID = 15, AgeMin = 0,  AgeMax = 30,   Name = "Do 30 let",              Code = "30-",   Gender = Gender.IRRELEVANT, Color = "Červená", Type = AgeCategoryType.DUOS },
            new AgeCategory() { ID = 16, AgeMin = 31, AgeMax = 70,   Name = "31 - 70 let",            Code = "31-70", Gender = Gender.IRRELEVANT, Color = "Červená", Type = AgeCategoryType.DUOS },
            new AgeCategory() { ID = 17, AgeMin = 71, AgeMax = null, Name = "Nad 70 let",             Code = "70+",   Gender = Gender.IRRELEVANT, Color = "Červená", Type = AgeCategoryType.DUOS },

            new AgeCategory() { ID = 18, AgeMin = 0,  AgeMax = 14,   Name = "Žáci 14 let a mladší",   Code = "H14-",  Gender = Gender.MALE,       Color = "Červená", Type = AgeCategoryType.RELAY },
            new AgeCategory() { ID = 19, AgeMin = 0,  AgeMax = 14,   Name = "Žákyně 14 let a mladší", Code = "D14-",  Gender = Gender.FEMALE,     Color = "Červená", Type = AgeCategoryType.RELAY },
            new AgeCategory() { ID = 20, AgeMin = 15, AgeMax = null, Name = "Muži 15 let a starší",   Code = "M15+",  Gender = Gender.MALE,       Color = "Červená", Type = AgeCategoryType.RELAY },
            new AgeCategory() { ID = 21, AgeMin = 15, AgeMax = null, Name = "Ženy 15 let a starší",   Code = "Ž15+",  Gender = Gender.FEMALE,     Color = "Červená", Type = AgeCategoryType.RELAY }
        );
